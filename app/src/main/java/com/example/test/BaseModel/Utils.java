...
public class Utils {
    ...
    public static String parseTime(String time){
        ...
        switch (alltime[1]){
            case "Nov":realTime[0]="11";break;
            case "Jan":realTime[0]="1";break;
            case "Feb":realTime[0]="2";break;
            case "Mar":realTime[0]="3";break;
            case "Apr":realTime[0]="4";break;
            case "May":realTime[0]="5";break;
            case "Jun":realTime[0]="6";break;
            case "Jul":realTime[0]="7";break;
            case "Aug":realTime[0]="8";break;
            case "Sep":realTime[0]="9";break;
            case "Oct":realTime[0]="10";break;
            case "Dec":realTime[0]="12";break;
            default:break;
        }
